...
用户确认只改文档锚点：当前有效观察/静默复核由 `2026-09-14 10:00` **提前**为 **`2026-08-10 06:00`**。仍 **WATCH**；≠ 自动 STABLE；到点须另确认是否复抓/回填；F4 / 公开发布 / 日更 / P1-A 真跑仍冻结；不立项 Freeze30+；不跑复抓。见目标项目 `docs/observation-anchor-to-2026-08-10-0600.md`。
